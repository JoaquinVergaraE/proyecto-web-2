...
<div class="bg-primary p-4 rounded-4 text-info ">
    ...
    <div class="list-group d-flex flex-column pb-2 text-center">
        ...
        <div class="rounded-3 mt-3">
            <a href="{{route('artistas.verArtistas')}}" class="list-group-item text-decoration-non fw-semibold fst-italic bg-info text-light " style="font-size:0.9rem; border: 1px solid black;">Ver usuarios y sus fotos</a>
        </div>
    </div>
@endsection
